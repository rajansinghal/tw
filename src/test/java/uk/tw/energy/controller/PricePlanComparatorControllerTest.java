...
public class PricePlanComparatorControllerTest {
  ...
  /*  private static final Plan PRICE_PLAN_1_ID = "test-supplier";
    private static final Plan PRICE_PLAN_2_ID = "best-supplier";
    private static final Plan PRICE_PLAN_3_ID = "second-best-supplier";
    ...
    public void setUp() {
        ...
        Map<String, Plan> meterToTariffs = new HashMap<>();
    ...
    public void shouldCalculateCostForMeterReadingsForEveryPricePlan() {
        ...
        Map<Plan, BigDecimal> expectedPricePlanToCost = new HashMap<>();
